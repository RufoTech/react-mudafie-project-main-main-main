    ...
    <div className="container">
        <div className="row">
            <div className="room-left-side col-12 col-md-6">
                ...
                <p className=''>We are waiting for you in our sales office for <br /> having all these opportunities with affordable <br /> prices and appropriate payment <br /> opportunities..</p>
            ...
            <div className="room-right-side col-12 col-md-6 py-5">
                <div className="row">
                    <div className="room-length1 col-4  col-md-4 col-lg-4 ">
                        <button>  <h5 className='poppins-bold'>1 Room 47m&sup2;</h5> </button>

                    </div>
                    <div className="room-length2 col-4 col-md-4 col-lg-4 ">
                        <button><h5 className='poppins-bold'>2 Rooms 65m&sup2;</h5></button>
                    </div>
                    <div className="room-length3 col-4 col-md-4 col-lg-4">
                        <button> <h5 className='poppins-bold'>3 Rooms 90m&sup2;</h5></button>
                    </div>
                </div>
                <img src="/assets/images/Homeplan/plan01.jpg" alt=""  className=''/>
                <img src="/assets/images/Homeplan/plan02.jpg" alt=""  className=''/>
                <img src="/assets/images/Homeplan/plan03.jpg" alt=""  className=''/>
