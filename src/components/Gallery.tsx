  ...
  return (
    <div className='gallery py-5 my-5'>
        <div className="container">
            <div className="row">
                <div  data-aos="fade-up" data-aos-duration="1500" className="gallery-left-side col-12 col-md-3">
              ...
              <a href="" className='all-gallery'>  <h6  className='poppins-bold text-dark  all-gallerys'>SEE ALL GALLERY <FaChevronRight className='fa-chevron-right' /> </h6> </a>
               ...
               <div  data-aos="fade-up" data-aos-duration="1500" className="gallery-right-side col-12 col-md-3">
